...
if selected == "Data Entry":
    ...
    if expense_data:
        ...
        st.info(
            "Start by adding members to track your expenses together! Currently, no members have been added. Get started by clicking the 'Add Member' from the Data Entry Tab."
        )
